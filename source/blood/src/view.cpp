...
void viewDrawMapTitle(void)
{
    ...
    int const isClassicRender = videoGetRenderMode() == REND_CLASSIC;
    int const fadeStartTic = int((isClassicRender ? 1.25f : 1.f) * kTicsPerSec);
    int const fadeEndTic = int((isClassicRender ? 1.5f : 1.5f) * kTicsPerSec);
