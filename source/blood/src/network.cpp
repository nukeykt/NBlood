...
void netCheckSync(void)
{
    ...
    while (1)
    {
        ...
        for (int p = connecthead; p >= 0; p = connectpoint2[p])
        {
            ...
            OSD_Printf("used1: %i and address %u\n", gPlayer[p].used1, &(gPlayer[p].used1));
            OSD_Printf("weaponQav: %i and address %u\n", gPlayer[p].weaponQav, &(gPlayer[p].weaponQav));
            OSD_Printf("qavCallback: %i and address %u\n", gPlayer[p].qavCallback, &(gPlayer[p].qavCallback));
            OSD_Printf("isRunning: %u and address %u\n", gPlayer[p].isRunning, &(gPlayer[p].isRunning));
            OSD_Printf("posture: %i and address %u\n", gPlayer[p].posture, &(gPlayer[p].posture));
            OSD_Printf("sceneQav: %i and address %u\n", gPlayer[p].sceneQav, &(gPlayer[p].sceneQav));
            OSD_Printf("bobPhase: %i and address %u\n", gPlayer[p].bobPhase, &(gPlayer[p].bobPhase));
            OSD_Printf("bobAmp: %i and address %u\n", gPlayer[p].bobAmp, &(gPlayer[p].bobAmp));
            OSD_Printf("bobHeight: %i and address %u\n", gPlayer[p].bobHeight, &(gPlayer[p].bobHeight));
            OSD_Printf("bobWidth: %i and address %u\n", gPlayer[p].bobWidth, &(gPlayer[p].bobWidth));
            OSD_Printf("swayPhase: %i and address %u\n", gPlayer[p].swayPhase, &(gPlayer[p].swayPhase));
            OSD_Printf("swayAmp: %i and address %u\n", gPlayer[p].swayAmp, &(gPlayer[p].swayAmp));
            OSD_Printf("swayHeight: %i and address %u\n", gPlayer[p].swayHeight, &( gPlayer[p].swayHeight));
            OSD_Printf("swayWidth: %i and address %u\n", gPlayer[p].swayWidth, &(gPlayer[p].swayWidth));
            OSD_Printf("nPlayer: %i and address %u\n", gPlayer[p].nPlayer, &(gPlayer[p].nPlayer));
            OSD_Printf("nSprite: %i and address %u\n", gPlayer[p].nSprite, &(gPlayer[p].nSprite));
            OSD_Printf("lifeMode: %i and address %u\n", gPlayer[p].lifeMode, &(gPlayer[p].lifeMode));
            OSD_Printf("bloodlust: %i and address %u\n", gPlayer[p].bloodlust, &(gPlayer[p].bloodlust));
            OSD_Printf("zView: %i and address %u\n", gPlayer[p].zView, &(gPlayer[p].zView));
            OSD_Printf("zViewVel: %i and address %u\n", gPlayer[p].zViewVel, &(gPlayer[p].zViewVel));
            OSD_Printf("zWeapon: %i and address %u\n", gPlayer[p].zWeapon, &(gPlayer[p].zWeapon));
            OSD_Printf("zWeaponVel: %i and address %u\n", gPlayer[p].zWeaponVel, &(gPlayer[p].zWeaponVel));
            OSD_Printf("q16look: %i and address %u\n", gPlayer[p].q16look, &(gPlayer[p].q16look));
            OSD_Printf("q16horiz: %i and address %u\n", gPlayer[p].q16horiz, &(gPlayer[p].q16horiz));
            OSD_Printf("q16slopehoriz: %i and address %u\n", gPlayer[p].q16slopehoriz, &(gPlayer[p].q16slopehoriz));
            OSD_Printf("slope: %i and address %u\n", gPlayer[p].slope, &(gPlayer[p].slope));
            OSD_Printf("isUnderwater: %i and address %u\n", gPlayer[p].isUnderwater, &(gPlayer[p].isUnderwater));
            //bool                hasKey[8];
            OSD_Printf("hasFlag: %i and address %u\n", gPlayer[p].hasFlag, &(gPlayer[p].hasFlag));
            //short               used2[8]; 
            //int                 damageControl[7];
            ...
            //int                 ammoCount[12];
            OSD_Printf("qavLoop: %i and address %u\n", gPlayer[p].qavLoop, &(gPlayer[p].qavLoop));
            OSD_Printf("fuseTime: %i and address %u\n", gPlayer[p].fuseTime, &(gPlayer[p].fuseTime));
            OSD_Printf("throwTime: %i and address %u\n", gPlayer[p].throwTime, &(gPlayer[p].throwTime));
            OSD_Printf("throwPower: %i and address %u\n", gPlayer[p].throwPower, &(gPlayer[p].throwPower));
            //Aim                 aim;  // world
            //Aim                 relAim;  // relative
            OSD_Printf("aimTarget: %i and address %u\n", gPlayer[p].aimTarget, &(gPlayer[p].aimTarget));
            OSD_Printf("aimTargetsCount: %i and address %u\n", gPlayer[p].aimTargetsCount, &(gPlayer[p].aimTargetsCount));
            //short               aimTargets[16];
            OSD_Printf("deathTime: %i and address %u\n", gPlayer[p].deathTime, &(gPlayer[p].deathTime));
            //int                 pwUpTime[kMaxPowerUps];
            OSD_Printf("fragCount: %i and address %u\n", gPlayer[p].fragCount, &(gPlayer[p].fragCount));
            //int                 fragInfo[8];
            OSD_Printf("teamId: %i and address %u\n", gPlayer[p].teamId, &(gPlayer[p].teamId));
            OSD_Printf("fraggerId: %i and address %u\n", gPlayer[p].fraggerId, &(gPlayer[p].fraggerId));
            OSD_Printf("underwaterTime: %i and address %u\n", gPlayer[p].underwaterTime, &(gPlayer[p].underwaterTime));
            OSD_Printf("bloodTime: %i and address %u\n", gPlayer[p].bloodTime, &(gPlayer[p].bloodTime));
            OSD_Printf("gooTime: %i and address %u\n", gPlayer[p].gooTime, &(gPlayer[p].gooTime));
            OSD_Printf("wetTime: %i and address %u\n", gPlayer[p].wetTime, &(gPlayer[p].wetTime));
            OSD_Printf("bubbleTime: %i and address %u\n", gPlayer[p].bubbleTime, &(gPlayer[p].bubbleTime));
            OSD_Printf("at306: %i and address %u\n", gPlayer[p].at306, &(gPlayer[p].at306));
