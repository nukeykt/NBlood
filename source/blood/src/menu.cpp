...
CGameMenuItemZEditBitmap unk_26D108(NULL, 3, 20, 80, 320, strRestoreGameStrings[1], 16, 1, SaveGame, 2);
CGameMenuItemZEditBitmap unk_26D140(NULL, 3, 20, 90, 320, strRestoreGameStrings[1], 16, 1, SaveGame, 3);
CGameMenuItemZEditBitmap unk_26D178(NULL, 3, 20, 100, 320, strRestoreGameStrings[1], 16, 1, SaveGame, 4);
CGameMenuItemZEditBitmap unk_26D1B0(NULL, 3, 20, 110, 320, strRestoreGameStrings[1], 16, 1, SaveGame, 5);
CGameMenuItemZEditBitmap unk_26D1E8(NULL, 3, 20, 120, 320, strRestoreGameStrings[1], 16, 1, SaveGame, 6);
CGameMenuItemZEditBitmap unk_26D220(NULL, 3, 20, 130, 320, strRestoreGameStrings[1], 16, 1, SaveGame, 7);
CGameMenuItemZEditBitmap unk_26D258(NULL, 3, 20, 140, 320, strRestoreGameStrings[1], 16, 1, SaveGame, 8);
CGameMenuItemZEditBitmap unk_26D290(NULL, 3, 20, 150, 320, strRestoreGameStrings[1], 16, 1, SaveGame, 9);
...
CGameMenuItemZEditBitmap unk_26D388(NULL, 3, 20, 80, 320, strRestoreGameStrings[1], 16, 1, LoadGame, 2);
CGameMenuItemZEditBitmap unk_26D3C0(NULL, 3, 20, 90, 320, strRestoreGameStrings[1], 16, 1, LoadGame, 3);
CGameMenuItemZEditBitmap unk_26D3F8(NULL, 3, 20, 100, 320, strRestoreGameStrings[1], 16, 1, LoadGame, 4);
CGameMenuItemZEditBitmap unk_26D430(NULL, 3, 20, 110, 320, strRestoreGameStrings[1], 16, 1, LoadGame, 5);
CGameMenuItemZEditBitmap unk_26D468(NULL, 3, 20, 120, 320, strRestoreGameStrings[1], 16, 1, LoadGame, 6);
CGameMenuItemZEditBitmap unk_26D4A0(NULL, 3, 20, 130, 320, strRestoreGameStrings[1], 16, 1, LoadGame, 7);
CGameMenuItemZEditBitmap unk_26D4D8(NULL, 3, 20, 140, 320, strRestoreGameStrings[1], 16, 1, LoadGame, 8);
CGameMenuItemZEditBitmap unk_26D510(NULL, 3, 20, 150, 320, strRestoreGameStrings[1], 16, 1, LoadGame, 9);
