...
#define MINIFONT (3522)
#define BIGALPHANUM (4111)
#define BIGPERIOD (4109)
#define BIGCOMMA (4107)
#define BIGX_ (4096)
#define BIGQ (4126)
#define BIGSEMI (4122)
#define BIGCOLIN (4121)
#define BIGAPPOS (4102)
#define STARTALPHANUM (3555)
...
void G_InitText()
{
    ...
    // font has no lowercase chars so map lowercase to upper
    for (i = 0; i <= 'z' - 'a'; ++i)
    {
        char c = 'a' + i;
        uint32_t chr32 = tilefontGetChr32FromASCII(c);
    ...
    for (i = 0; i <= '9' - '0'; ++i)
    {
        char c = '0' + i;
        uint32_t chr32 = tilefontGetChr32FromASCII(c);
        tilefontMaybeDefineMapping(tilefont_MINIFONT, chr32, STARTALPHANUM + i);
    }
...
{
    return scale(sc, /*ud.textscale*/200, 400); // TODO
}
