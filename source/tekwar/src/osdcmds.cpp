...
// TODO        { "cl_autorun", "enable/disable autorun", (void *)&auto_run, CVAR_BOOL, 0, 1 },
...
// TODO        { "cl_runmode", "enable/disable modernized run key operation", (void *)&runkey_mode, CVAR_BOOL, 0, 1 },
...
// TODO        { "fov", "change the field of view", (void *)&gFov, CVAR_INT|CVAR_FUNCPTR, 60, 140 },
...
// TODO        { "in_aimmode", "0:toggle, 1:hold to aim", (void *)&mouseaiming, CVAR_BOOL, 0, 1 },
        {
...
// TODO        { "r_showfps", "show the frame rate counter", (void *)&r_showfps, CVAR_INT, 0, 3 },
    ...
    //if (VOLUMEONE)
// TODO    OSD_RegisterFunction("changelevel","changelevel <level>: warps to the given level", osdcmd_changelevel);
    //else
    //{
...
// TODO    OSD_RegisterFunction("god","god: toggles god mode", osdcmd_god);
...
// TODO    OSD_RegisterFunction("noclip","noclip: toggles clipping mode", osdcmd_noclip);
