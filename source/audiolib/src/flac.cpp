...
int MV_PlayFLAC3D(char *ptr, uint32_t length, int loophow, int pitchoffset, int angle, int distance, int priority, fix16_t volume, uint32_t callbackval)
{
    int left;
    int right;
    int mid;
...
int MV_PlayFLAC(char *ptr, uint32_t length, int loopstart, int loopend, int pitchoffset, int vol, int left, int right, int priority, fix16_t volume, uint32_t callbackval)
{
    VoiceNode *voice;
    flac_data *fd = 0;
