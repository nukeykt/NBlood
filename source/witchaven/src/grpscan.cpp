...
static void LoadList(const char * filename)
{
...
#ifndef EDUKE32_STANDALONE
    scriptfile_addsymbolvalue("GAMEFLAG_WH",  GAMEFLAG_WH1);
    scriptfile_addsymbolvalue("GAMEFLAG_WH2", GAMEFLAG_WH2);
#endif
    ...
    while (!scriptfile_eof(script))
    {
        ...
        case T_GRPINFO:
        {
            int32_t gsize = 0, gcrcval = 0, gflags = GAMEFLAG_WH1, gdepcrc = WH1_CRC;
