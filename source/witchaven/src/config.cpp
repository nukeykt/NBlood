...
EWitchaven is free software; you can redistribute it and/or
...
int CONFIG_ReadSetup()
{
    ...
    SCRIPT_GetNumber(scripthandle, "Options", "GoreOn", &goreon);
    SCRIPT_GetNumber(scripthandle, "Options", "Difficulty", &difficulty);
    SCRIPT_GetNumber(scripthandle, "Options", "Brightness", &gbrightness);
...
*/
    Bsprintf(filename, "ewitchaven_cvars.cfg");
...
void CONFIG_WriteSetup(uint32_t flags)
{
    ...
    SCRIPT_PutNumber(scripthandle, "Options", "GoreOn", goreon, FALSE, TRUE);
    SCRIPT_PutNumber(scripthandle, "Options", "Difficulty", difficulty, FALSE, 2);
    SCRIPT_PutNumber(scripthandle, "Options", "Brightness", gbrightness, FALSE, 0);
