...
const memberlabel_t ActorLabels[]=
{
    ...
    LABEL_SETUP_UNMATCHED(spriteext, pivot_offset.x, "mdxoff",  ACTOR_MDXOFF),
    LABEL_SETUP_UNMATCHED(spriteext, pivot_offset.y, "mdyoff",  ACTOR_MDYOFF),
    LABEL_SETUP_UNMATCHED(spriteext, pivot_offset.z, "mdzoff",  ACTOR_MDZOFF),
    LABEL_SETUP_UNMATCHED(spriteext, position_offset.x, "posxoff",  ACTOR_POSXOFF),
    LABEL_SETUP_UNMATCHED(spriteext, position_offset.y, "posyoff",  ACTOR_POSYOFF),
    LABEL_SETUP_UNMATCHED(spriteext, position_offset.z, "poszoff",  ACTOR_POSZOFF),
