...
typedef struct vec3_ {
    ...
    struct vec3_ &operator+=(const struct vec2_& rhs) { vec2 += rhs; return *this; }
    struct vec3_ &operator-=(const struct vec2_& rhs) { vec2 -= rhs; return *this; }
...
typedef struct vec3_16_ {
    ...
    struct vec3_16_ &operator+=(const struct vec2_16_& rhs) { vec2 += rhs; return *this; }
    struct vec3_16_ &operator-=(const struct vec2_16_& rhs) { vec2 -= rhs; return *this; }
...
typedef struct vec3f_ {
    ...
    struct vec3f_ &operator+=(const struct vec2f_& rhs) { vec2 += rhs; return *this; }
    struct vec3f_ &operator-=(const struct vec2f_& rhs) { vec2 -= rhs; return *this; }
...
typedef struct vec3d_ {
    ...
    struct vec3d_ &operator+=(const struct vec2d_& rhs) { vec2 += rhs; return *this; }
    struct vec3d_ &operator-=(const struct vec2d_& rhs) { vec2 -= rhs; return *this; }
